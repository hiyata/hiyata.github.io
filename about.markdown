...
<div class="about-page">
  <header class="about-hero">
    <div class="about-hero-photo"></div>
    <div class="about-hero-copy">
      ...
      <div class="about-hero-social">
        ...
        <a href="https://github.com/hiyata" target="_blank" rel="noopener" aria-label="GitHub"><i class="fab fa-github"></i></a>
        <a href="https://huggingface.co/hiyata" target="_blank" rel="noopener" aria-label="Hugging Face"><i class="fas fa-robot"></i></a>
      </div>
    </div>
  </header>
    ...
    <div class="section-grid">
      ...
      <div class="section-body">
        ...
        <div class="skills-container">
          ...
          <div class="skill-category">
            <h3><i class="fas fa-virus"></i> Virology &amp; Genomics</h3>
            <div class="skill-grid">
              <div class="skill-item">
          ...
          <div class="skill-category">
            <h3><i class="fas fa-code"></i> Engineering</h3>
            <div class="skill-grid">
              <div class="skill-item">
                <h4>Languages</h4>
                <div class="skill-details">
      ...
      <div class="section-body">
        ...
        <div class="record-list">
          <div class="record-item">
            ...
            <p>Alan L. Carbajo Jr., Taylor A. Vensko, Philip E. Pellett &mdash; <em>Virus Evolution</em>, Vol. 12, Issue 1, veag009 &middot; Feb 2026</p>
          </div>
        </div>
      </div>
    </div>
...
.about-hero {
  ...
  margin: 0 auto;
  padding: clamp(2rem, 5vh, 3rem) max(1.5rem, 4vw);
}
